...
#############
{
    ...
    echo
    echo "${MSG_WELCOME_MESSAGE_4}"
    echo "${MSG_WELCOME_MESSAGE_5}"
    echo "${MSG_WELCOME_MESSAGE_6}"
    echo "${MSG_WELCOME_MESSAGE_7}"
    echo "${MSG_WELCOME_MESSAGE_8}"
    echo "${MSG_WELCOME_MESSAGE_9}"
    echo "${MSG_WELCOME_MESSAGE_10}"
    echo
    echo "${MSG_WELCOME_MESSAGE_11}"
    echo "${MSG_WELCOME_MESSAGE_12}"
    echo
    echo "${MSG_WELCOME_MESSAGE_13}"
    echo "${MSG_WELCOME_MESSAGE_14}"
    echo "${MSG_WELCOME_MESSAGE_15}"
    echo "${MSG_WELCOME_MESSAGE_16}"
    echo "${MSG_WELCOME_MESSAGE_17}"
    echo "${MSG_WELCOME_MESSAGE_18}"
    echo "${MSG_WELCOME_MESSAGE_19}"
    echo
    echo "${MSG_WELCOME_MESSAGE_20}"
    echo "${MSG_WELCOME_MESSAGE_21}"
    echo
...
##########################
{
    ...
    echo "29) ${MSG_COUNTRY_29}"
    echo "30) ${MSG_COUNTRY_30}"
}
